...
wait_for_healthy(){
        ...
        KUBECONFIG=/etc/rancher/rke2/rke2.yaml kubectl get pods -A
}
...
#cp ${FOLDER_PATH}/other_deps/*.tar /var/lib/rancher/rke2/agent/images/
#zcat ${FOLDER_PATH}/other-deps.tar.gz > /var/lib/rancher/rke2/agent/images/other-deps.tar
